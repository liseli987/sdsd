...
if ((x.Type === client.Types.Jail || x.Type === client.Types.PermaJail || x.Type === client.Types.Reklam) && !member.roles.cache.has(role.JailRole)) return member.roles.set(member.roles.cache.has(role.BoosterRole) ? [role.BoosterRole, role.JailRole] : [role.JailRole]).catch();
if (x.Type === client.Types.VoiceMute) {
